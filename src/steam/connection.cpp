...
void processPacket(const QByteArray& packet) {
    ...
    SteamKit::EMsg emsg = static_cast<SteamKit::EMsg>(rawEmsg & antiProtoMask);
    ...
    if (emsg == SteamKit::EMsg::Multi) {
        if (handleMulti(body)) {
            return;
        }
    } else if (emsg == SteamKit::EMsg::ServiceMethodResponse) {
...
void SteamConnection::sendProtobufMessage(SteamKit::EMsg                   emsg,
...
void SteamConnection::sendClientHello() {
    CMsgClientHello helloMessage{};
    helloMessage.set_protocol_version(SteamKit::MsgClientLogon::CurrentProtocol);
    sendProtobufMessage(SteamKit::EMsg::ClientHello, helloMessage, CMsgProtoBufHeader{});
}