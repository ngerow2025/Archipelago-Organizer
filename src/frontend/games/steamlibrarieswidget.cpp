...
SteamLibrariesWidget::SteamLibrariesWidget(QWidget* parent) : QWidget(parent) {
    createUI();
}
...
void SteamLibrariesWidget::createUI() {
    ...
    connect(scanForGamesButton, &QPushButton::clicked, this,
            &SteamLibrariesWidget::scanForGamesClicked);
...
void SteamLibrariesWidget::addLibrary(const QString& path) {
    ...
    connect(deleteButton, &QPushButton::clicked, this,
            [this, path]() { emit deleteLibraryRequested(path); });
